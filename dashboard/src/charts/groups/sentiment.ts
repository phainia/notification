  ...
  charts: [
    {
      ...
      subtitle: "主指数(0-100)+ CNN CSV 全部数值列(可用图例开关)",
      series: [
        { csv: "macro/fng", col: "fng", name: "F&G 指数" },
        { csv: "macro/fng", col: "momentum_spx", name: "SPX 动量", axis: 1, off: true },
        { csv: "macro/fng", col: "momentum_spx_ma125", name: "SPX 125日均", axis: 1, off: true },
        { csv: "macro/fng", col: "strength_52w", name: "52周强度", axis: 1, off: true },
        { csv: "macro/fng", col: "breadth_mcclellan", name: "McClellan 宽度", axis: 1, off: true },
        { csv: "macro/fng", col: "putcall_5d", name: "P/C 5日均", axis: 1, off: true },
        { csv: "macro/fng", col: "vix", name: "VIX", axis: 1, off: true },
        { csv: "macro/fng", col: "vix_ma50", name: "VIX 50日均", axis: 1, off: true },
      ...
      note: "官方 API 2020-09~2021-01 回填段为占位脏值,2021-02 起为有效值;分量为 CNN 原始量纲,值域差异大,默认只开主指数。",
      defaultYears: 3,
    },
    {
      id: "aaii",
